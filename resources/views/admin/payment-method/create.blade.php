...
@section("content")
    ...
    <div class="row">
        <div class="col-lg-10 m-auto">
            <div class="tile">
                <h3 class="tile-title">Create Payment Method</h3>
                <div class="tile-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="currencies[]" id="CurrenciesSelect" multiple="" >
                                        <optgroup label="Select Currencies">
                                            ...
                                            <option value="{{$currency->id}}" {{isset(old("currenciesSelected")[$currency->id]) ? "selected" : ""}}>{{$currency->code}}</option>
                                            @endforeach
                                        </optgroup>
                                    </select>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @if($errors->has('min_deposit')) is-invalid @endif" type="text" name="min_deposit" value="{{inputValue("min_deposit")}}">
                                </div>
                                @error("min_deposit")
                                <div class="input-error">{{$message}}</div>
                                @enderror
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @if($errors->has('max_deposit')) is-invalid @endif" type="text" name="max_deposit" value="{{inputValue("max_deposit")}}">
                                </div>
                                @error("max_deposit")
                                <div class="input-error">{{$message}}</div>
                                @enderror
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @if($errors->has('min_withdrawal')) is-invalid @endif" type="text" name="min_withdrawal" value="{{inputValue("min_withdrawal")}}">
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @if($errors->has('max_withdrawal')) is-invalid @endif" type="text" name="max_withdrawal" value="{{inputValue("max_withdrawal")}}">
                                </div>
